...
@Component({
  selector: 'app-chn-channel-partner',
  templateUrl: './chn-channel-partner.component.html',
  styleUrls: ['./chn-channel-partner.component.css']
})
export class ChnChannelPartnerComponent implements OnInit {
    ...
    if (this.partnerForm.valid) {
      ...
      const params = {
        ...
        Message: {
          ...
          Subject: {
            Charset: 'UTF-8',
            Data: 'CHN Partner Program Registration'
          }
        },
